<template>
    <aside class="sidebar-product col-lg-3 mobile-sidebar" sticky-container>
        <div
        ...
        >
            ...
            <div class="widget widget-product-categories mb-3" v-else>
                    ...
                    >
                        <template v-slot:leafNameDisplay="slotProps">
                            <nuxt-link
                                ...
                                >{{ slotProps.model.name }}</nuxt-link
                            >
                        </template>
