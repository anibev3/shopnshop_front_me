            ...
            >
                <div class="product-desc-content" v-if="isFullwidth">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-sm-6 col-xl-4">
                            <div
                                class="feature-box feature-box-simple text-center"
                            >
                                ...
                                <div class="feature-box-content">
                                    ...
                                    <p>
                                        Consult our specialists for help with an
                                        order, customization, or design advice
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <p>
                        ...
                        exercitation ullamco laboris nisi ut aliquip ex ea
                        commodo consequat. Duis aute irure dolor in
                        reprehenderit in voluptate velit esse cillum dolore.Duis
                ...
                <div class="product-desc-content" v-else>
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                        sed do eiusmod tempor incididunt ut labore et dolore
                        magna aliqua. Ut enim ad minim veniam, nostrud ipsum
                        consectetur sed do, quis nostrud exercitation ullamco
            ...
            >
                ...
                >
                    <h3
                        ...
                        key="singleReview"
                    >
                        {{ product.reviews }} review for {{ product.name }}
                    </h3>
                    <h3 class="reviews-title" v-else>
                        {{ product.reviews }} reviews for {{ product.name }}
                    </h3>

                    <div class="comment-list">
                        <div
                            class="comments"
                            v-for="(item, index) in [0, 1, 2, 3, 4, 5].slice(
                                0,
                                product.reviews
                            )"
                            :key="'reviews-' + index"
                        ...
                        >
                            ...
                            <div class="comment-block mt-2">
                                <div class="comment-header">
                                    ...
                                    <div
                                        class="ratings-container float-sm-right"
                                    >
                                    ...
                                    <span class="comment-by">
                                        <strong>Joe Doe</strong> – April 12,
                                        2018
                                    </span>
                                </div>
                ...
                <div class="product-reviews-content" v-else>
