<template>
    <pv-tabs class="product-single-tabs product-tabs-list pt-3 mb-0 mt-1">
        <div class="container">
            <div class="row">
                <div class="col-lg-2">
                        ...
                        >
                            <div class="product-desc-content">
                                <p>
                                    ...
                                    Ut enim ad minim veniam, nostrud ipsum
                                    consectetur sed do, quis nostrud
                                ...
                                <ul>
                                    ...
                                    <li>
                                        Inventory Management with Backordered
                                        items
                                    </li>
                                </ul>
                                <p>
