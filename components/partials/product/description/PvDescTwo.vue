<template>
    <div class="product-single-collapse">
                    ...
                    <div class="collapse-body-wrapper">
                        <div class="product-desc-content">
                            <p>
                                ...
                                enim ad minim veniam, nostrud ipsum consectetur
                                sed do, quis nostrud exercitation ullamco
                        ...
                        <div class="product-size-content">
                            <div class="row">
                                <div class="col-md-4">
                                    <img
                                        v-lazy="
                                            './images/products/body-shape.png'
                                        "
                                        alt="body shape"
                                    />
                                </div>
        ...
        <div class="product-collapse-panel">
            ...
            <vue-slide-toggle :open="toggleState[2]">
                <div class="product-collapse-body">
                    <div class="collapse-body-wrapper" v-if="product">
                        <div
                        ...
                        >
                            <h3
                                ...
                                key="singleReview"
                            >
                                {{ product.reviews }} review for
                                {{ product.name }}
                            </h3>
                            <h3 class="reviews-title" v-else>
                                {{ product.reviews }} reviews for
                                {{ product.name }}
                            </h3>
