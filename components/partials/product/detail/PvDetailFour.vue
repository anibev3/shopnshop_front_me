    ...
    <div class="product-single-details">
        <div class="product-single-header position-relative">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div
                        class="product-single-share pb-4 pb-lg-0 align-items-start justify-content-lg-end"
                    >
            ...
            <div class="row">
                <div class="col-xl-6">
                    ...
                    <div class="price-box pb-4 pb-xl-0" v-else>
        ...
        >
            ...
            <div
                class="product-action mb-2 d-flex align-items-center flex-wrap p-0 border-0"
            >
