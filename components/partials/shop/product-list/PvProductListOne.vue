    ...
    <div>
        ...
        >
            <div class="toolbox-left">
                <a
                    href="javascript:;"
                    class="sidebar-toggle mb-0 mb-lg-1"
        ...
        <div class="divide-line-wrapper">
            <div
                class="row products-group"
                style="margin-bottom: -1px"
                :class="{
                    'row-sm sm-padding': itemsPerRow > 6,
                    'row-joined divide-line': itemsPerRow !== 1,
                }"
            >
                ...
                <template v-if="!products">
                    <div
                        :class="gridCols[itemsPerRow]"
                        v-for="(item, index) in repeatCount.slice(
                            0,
                            itemsPerPage
                        )"
                        :key="'skel-shop' + index"
    ...
    data: function () {
        return {
            ...
            gridCols: {
                1: 'col-12',
                3: 'col-6 col-sm-4',
                4: 'col-6 col-sm-4 col-md-3 col-lg-4 col-xl-3',
