    ...
    <main class="main main-test">
        <div class="container checkout-container">
                ...
                <div class="checkout-discount">
                    <h4>
                        ...
                        <button data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true"
                            aria-controls="collapseOne" class="btn btn-link btn-toggle"
                                ...
                                <form action="#">
                                    <div class="input-group">
                                        <input type="text" class="form-control form-control-sm w-auto"
                                            placeholder="Code coupon" required />
                    ...
                    <div class="col-lg-7">
                        <!-- <div class="login-form-container">
                            <div class="d-flex" style="cursor: pointer">
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                                    viewBox="0 0 24 24" style="width: 22px">
                        ...
                        <div class="login-form-container">
                            <div class="d-flex" style="cursor: pointer">
                                ...
                                <h3 @click="openBillingAddress()" style="margin-left: 15px; font-size: 1.875rem;">
                                    ...
                                    <div class="feature-box-content">
                                        <div v-if="GET_BILLING">
                                                ...
                                                <div class="feature-box yooo">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            Adresse
                                                            1 :
                                                            {{ GET_BILLING . address_line1 }}
                                                        </div>
                                                        <div class="col-lg-4">
                                                            Adresse
                                                            2 :
                                                            {{ GET_BILLING . address_line2 }}
                                                        </div>
                                                        <div class="col-lg-4">
                                                            Code
                                                            postal :
                                                            {{ GET_BILLING . postal_code }}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div>
                                                ...
                                                <div @click="openUpdateBillingModal()" class="aaaa">
                                                    MODIFIER L'ADRESSE
                                                </div>
                                            ...
                                            <div class="d-flex justify-content-end">
                                                <div class="aaaa" @click="next()">
                                                    SUIVANT
                                                </div>
                                            </div>

                                        </div>
                                        <div v-if="!GET_BILLING" class="aaaa">
                                            <p>
                                                Vous n'avez pas encore paramétré
                                                ce type d'adresse .
                                            </p>
                                            <div @click="openCreateBillingModal()">
                                                CREER UNE ADRESSE DE FACTURATION
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="login-form-container">
                            <div class="d-flex" style="cursor: pointer">
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                                    viewBox="0 0 24 24" style="color: green; width: 22px">
                                    <path fill="currentColor"
                                        d="M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2m0 18a8 8 0 1 1 8-8a8 8 0 0 1-8 8" />
                                    <path fill="currentColor"
                                        d="m14.7 8.39l-3.78 5l-1.63-2.11a1 1 0 0 0-1.58 1.23l2.43 3.11a1 1 0 0 0 .79.38a1 1 0 0 0 .79-.39l4.57-6a1 1 0 1 0-1.6-1.22Z" />
                                </svg>
                                <h3 @click="openShippingAddress()" style="margin-left: 15px; font-size: 1.875rem;"">
                            ...
                            <vue-slide-toggle :open="shippingInfoToggle">
                                <div class="login-section feature-box bg-gray">
                                    <div class="feature-box-content" style="background-color: #f9f9f9">
                                        <div class="address-box" v-if="GET_SHIPPING.length == 0">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 address-box"
                                                                ...
                                                                <div class="feature-box bg-white"
                                                                    ...
                                                                    :class="{
                                                                        'address-box': true,
                                                                        'selected-address': shipping_address ===
                                                                            selectedShippingAddress,
                                                                        'not-selected-address': shipping_address !==
                                                                            selectedShippingAddress,
                                                                    }">
                                                                    <div class="checkmark"
                                                                        v-if="
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <span @click="openCreateShippingModal"
                                                class="btn btn-default address-action link-to-tab">Ajouter une
                                                Adresse</span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-5">
                        <div class="order-summary">
                            ...
                            <table class="table table-mini-cart">
                                ...
                                <tfoot>
                                    <tr class="cart-subtotal">
                                        ...
                                        <td class="price-col">
                                            <span>{{ numberWithSpaces(cartAmount . ht_amount) }}</span>
                                        </td>
                                    </tr>
                                    <tr class="cart-subtotal">
                                        <td>
                                        ...
                                        <td class="price-col">
                                            <span>{{ numberWithSpaces(cartAmount . tax_amount) }}</span>
                                        </td>
                                    </tr>
                                        ...
                                        <td class="text-left" colspan="2">
                                            ...
                                            <div class="form-group form-group-custom-control">
                                                <div class="custom-control custom-radio d-flex">
                                                    <input type="radio" class="custom-control-input" name="radio"
                                                        checked />
                                                    <label class="custom-control-label">Recuperation au point
                                                        relais</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group form-group-custom-control mb-0">
                                                <div class="custom-control custom-radio d-flex mb-0">
                                                    ...
                                                    <label class="custom-control-label">Livraison à
                                                        domicile</label>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr class="order-total">
                                        ...
                                        <td>
                                            <b class="total-price">
                                                <span>{{ numberWithSpaces(cartAmount . total_amount) }}</span>
                                            </b>
                                        </td>
                                    </tr>
                                </tfoot>
                            ...
                            <button type="submit" class="btn btn-dark btn-place-order" form="checkout-form"
                                @click="makeUserOrder()" style="border-radius: 10px">
            ...
            <div class="box-content" v-else>
                <table class="table-cart" data-pagination="no" data-per-page="5" data-page="1" data-id data-token>
                    <thead class="d-none">
                        <tr>
                    ...
                    <tbody class="cart-items-wrapper">
                        ...
                        <tr class="border-0 py-0">
                            <td colspan="6" class="px-3 text-center">
                                <nuxt-link to="/shop" class="btn btn-go-shop">RETOUR À LA BOUTIQUE</nuxt-link>
                            </td>
                        </tr>
                    </tbody>
                </table>
...
<style scoped>
    .selected {
        ...
        /* Couleur de fond sélectionnée */
        border-color: #00cc00;
        /* Couleur de la bordure sélectionnée */
    ...
    .checkmark-svg {
        ...
        height: 20px;
        fill: #00cc00;
        /* Couleur du SVG de vérification */
    }
