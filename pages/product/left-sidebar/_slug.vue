            ...
            <div class="row">
                ...
                <div class="col-lg-9 main-content pb-2 skeleton-body">
                    ...
                    >
                        <div class="row">
                            <div
                                class="col-lg-7 col-md-6 product-single-gallery"
                            >
                                <pv-media-one :product="product"></pv-media-one>
                            </div>

                            <div
                                class="col-lg-5 col-md-6 product-single-details"
                            >
                                <pv-detail-one
                                    :product="product"
                    ...
                    <div class="skel-group" v-else>
                        ...
                        <div
                            class="summary entry-summary col-lg-5 col-md-6"
                        ></div>
...
import PvLeftSidebar from '~/components/partials/product/PvLeftSidebar';
